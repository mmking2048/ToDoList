	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Reset priority to default (med)
				mPriorityRadioGroup.check(mDefaultPriorityButton.getId());

				// Reset status to default (not done)
...
//				if (alarmCheck.isChecked() && status == Status.NOTDONE){
//					Context context = getApplicationContext();
//
//					AlarmUtils.setAlarm(context, mPosition, mDate, titleString);
//
//					// TODO in EditToDoActivity:
//					// 1. Check is not checked at beginning and at end. Don't do anything.
//					// 2. Check is not checked at beginning and is checked at end. Set new alarm.
//					// 3. Check is checked at beginning and is cancelled. Cancel old alarm
//					// 4. Check is checked at beginning and is still checked.
//					//   Need to check if alarm time has changed.
//					//   If no, nothing needs to be done.
//					//   If yes, cancel old alarm and set ned alarm
//					//
//					// Current implementation:
//					// Cancel alarm when editing and set alarm again when finished editing.
//					//
//					// FIXME:
//					// 1. BroadcastReceiver.onReceive not getting called.
//					// 2. Too many alarm messages. Hide some of them.
//				}
